...
import '../../UserRestaurant/ModalVenta/modalVenta.css';

const CreanVentaWine = ({ grupoId ,onVentaCreada, reloadData }) => {
  ...
  const [mostrarModal, setMostrarModal] = useState(false);
    ...
    const manejarEnvio = async (event) => {
      ...
      if (event) {
          ...
          const url = 'http://localhost:8080/ventas/guardarW';
